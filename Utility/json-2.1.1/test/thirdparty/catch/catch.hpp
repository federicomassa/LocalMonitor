...
void throwLogFunctionsicError(std::string const &message, SourceLineInfo const &locationInfo);
...
#define CATCH_INTERNAL_ERROR( msg ) ::Catch::throwLogFunctionsicError( msg, CATCH_INTERNAL_LINEINFO );
