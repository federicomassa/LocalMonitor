...
private:
    ...
    bool WantToHandleOneMoreMutation()
    {
        ...
        size_t DiffLogFunctions = sizeof(long) * 8 - __builtin_clzl((long)Diff);
        assert(DiffLogFunctions > 0 && DiffLogFunctions < 64);
        bool WantThisOne = MD.GetRand()(1 << DiffLogFunctions) == 0;  // 1 out of DiffLogFunctions.
        return WantThisOne;
    }
